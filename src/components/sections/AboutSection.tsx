    ...
    <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
      ...
      <div className="text-center mb-16">
        ...
        <p className="text-xl text-gray-600 max-w-4xl mx-auto leading-relaxed">
          On accompagne les personnes âgées de 65 ans et plus dans leur
          quotidien à domicile. Nos intervenants formés assurent avec
          bienveillance et professionnalisme l&apos;aide aux tâches ménagères,
          la toilette, les repas et le soutien relationnel.
        </p>
      </div>
        ...
        <div className="grid md:grid-cols-3 gap-8">
          <div className="bg-gradient-to-br from-white to-emerald-50 rounded-2xl p-8 shadow-xl border border-emerald-100">
            ...
            <p className="text-gray-600 text-lg leading-relaxed">
              Activités physiques adaptées à domicile par des professionnels
              qualifiés.
            </p>
          </div>
          <div className="bg-gradient-to-br from-white to-emerald-50 rounded-2xl p-8 shadow-xl border border-emerald-100">
            ...
            <h4 className="text-2xl font-bold text-gray-900 mb-4">
              Services Exclusifs pour les 65+
            </h4>
            <p className="text-gray-600 text-lg leading-relaxed">
              Services exclusifs spécialement conçus pour répondre aux besoins
              uniques des personnes âgées de 65 ans et plus.
            </p>
          </div>
          <div className="bg-gradient-to-br from-white to-emerald-50 rounded-2xl p-8 shadow-xl border border-emerald-100">
            ...
            <h4 className="text-2xl font-bold text-gray-900 mb-4">
              Système de Jumelage Innovant
            </h4>
            <p className="text-gray-600 text-lg leading-relaxed">
              Nous associons chaque personne âgée à un professionnel dédié,
              créant ainsi un lien de confiance unique pour une aide
        ...
        {[
          {
            ...
            content:
              "Un soutien professionnel dans le confort et la familiarité de votre propre environnement domestique.",
          ...
          },
          {
            ...
            content:
              "Des services adaptés qui respectent les besoins, valeurs et dignité de chaque personne âgée.",
          ...
          },
          {
            ...
            content:
              "Notre personnel est certifié, formé régulièrement et possède toutes les accréditations nécessaires pour offrir des soins de qualité supérieure.",
            badge: "Certifié",
          },
        ].map((item, index) => (
          <Card
      ...
      <div className="mt-20 bg-gradient-to-br from-emerald-50 to-teal-50 rounded-xl p-8 text-center shadow-xl">
        ...
        <p className="text-gray-600 max-w-3xl mx-auto text-lg mb-6">
          Nous croyons que des soins de qualité vont au-delà de la simple
          satisfaction des besoins de base. Notre équipe est dédiée à fournir un
          soutien complet qui améliore le bien-être général et le bonheur de
          chaque personne âgée que nous aidons.
        </p>
        <p className="font-semibold">
          Fait confiance par des familles à travers la communauté
        </p>
      </div>
    </div>
  </section>
